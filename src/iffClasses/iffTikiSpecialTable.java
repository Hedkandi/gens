 ...
 * @author hedkandi
 */
public class iffTikiSpecialTable {
    public int ID = 0; // 4 bytes - 1 or 0 - byte 0-3
    public int ItemID = 0; // 4 bytes - byte 4-7
    ...
    public iffTikiSpecialTable(byte[] inData) {
        getItem(inData);
    }

    public iffTikiSpecialTable() {
    ...
    public void getItem(String[] inData) throws IOException {
        ...
        U45 = uData.getByte(inData[46]);
        U46 = uData.getByte(inData[47]);
        U47 = uData.getByte(inData[48]);
        U48 = uData.getByte(inData[49]);
        U49 = uData.getByte(inData[50]);
        U50 = uData.getByte(inData[51]);
        U51 = uData.getByte(inData[52]);
        U52 = uData.getByte(inData[53]);
